...
on this dataset, and more details refer to our [arxiv paper](). 
...
* 本项目提供了一个大规模的经过系统清洗的中文对话数据集，并提供在此数据集上的对话预训练模型，更多信息可参考我们的[论文]()。
...
|---------------| ------ |--------------------------|-------------------------------------------------- |
| [GPT<sub>Novel</sub>](https://coai-dataset.oss-cn-beijing.aliyuncs.com/GPT_Novel.zip) | 104M | Chinese Novel            | Pre-trained on Chinese Novel dataset (1.3B words) |
| [GPT<sub>LCCC-base</sub>](https://coai-dataset.oss-cn-beijing.aliyuncs.com/GPT_LCCC-base.zip)  | 104M | [LCCC-base](##datasets)  | Post-trained on LCCC-base dataset from GPT<sub>Novel</sub> |
| [GPT2<sub>LCCC-base</sub>](https://coai-dataset.oss-cn-beijing.aliyuncs.com/GPT2_LCCC-base.zip) | 104M | [LCCC-base](##datasets)  | Post-trained on LCCC-base dataset from GPT<sub>Novel</sub> |
| [GPT<sub>LCCC-large</sub>](https://coai-dataset.oss-cn-beijing.aliyuncs.com/GPT_LCCC-large.zip) | 104M | [LCCC-large](##datasets) | Post-trained on LCCC-large dataset from GPT<sub>Novel</sub> |
...
## Citation
We'll release our paper on arxiv soon. Please kindly cite our [paper]() if you use the dataset or models in your research.